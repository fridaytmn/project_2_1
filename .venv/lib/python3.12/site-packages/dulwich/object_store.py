...
class BaseObjectStore:
    ...
    def determine_wants_all(self, refs: Dict[Ref, ObjectID], depth: Optional[int] = None) -> List[ObjectID]:
        ...
        return [
            ...
            if (sha not in self or _want_deepen(sha)) and not ref.endswith(PEELED_TAG_SUFFIX) and not sha == ZERO_SHA
        ]
    ...
    for e in lst:
        try:
            ...
            if isinstance(o, Commit):
                ...
                tags.add(e)
                tagged = o.object[1]
                c, t, os = _split_commits_and_tags(obj_store, [tagged], ignore_unknown=ignore_unknown)
                commits |= c
                tags |= t
                others |= os
            else:
...
class MissingObjectFinder:
    ...
    def __init__(
        ...
        *,
        ...
        all_ancestors = _collect_ancestors(object_store, have_commits, shallow=shallow, get_parents=self._get_parents)[
            0
        ]
