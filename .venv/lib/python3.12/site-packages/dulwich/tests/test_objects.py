...
class CommitParseTests(ShaFileCheckTests):
    ...
    def test_check_commit_with_unparseable_time(self):
        ...
        self.assertCheckFails(
            Commit,
            self.make_commit_text(author=default_committer, committer=identity_with_wrong_time),
        )
        self.assertCheckFails(
            Commit,
            self.make_commit_text(author=identity_with_wrong_time, committer=default_committer),
        )
    ...
    def test_mangled_author_line(self):
        ...
        author_line = (
            b'Karl MacMillan <kmacmill@redhat.com> <"Karl MacMillan ' b'<kmacmill@redhat.com>"> 1197475547 -0500'
        )
        expected_identity = b'Karl MacMillan <kmacmill@redhat.com> <"Karl MacMillan ' b'<kmacmill@redhat.com>">'
...
default_tagger = b"Linus Torvalds <torvalds@woody.linux-foundation.org> " b"1183319674 -0700"
...
class TagParseTests(ShaFileCheckTests):
    ...
    def test_check(self):
        ...
        self.assertCheckFails(
            Tag,
            self.make_tag_text(tagger=b"some guy without an email address 1183319674 -0700"),
        )
        self.assertCheckFails(
            Tag,
            self.make_tag_text(
                tagger=(b"Linus Torvalds <torvalds@woody.linux-foundation.org> " b"Sun 7 Jul 2007 12:54:34 +0700")
            ),
        )
    ...
    def test_check_tag_with_unparseable_field(self):
        self.assertCheckFails(
            Tag,
            self.make_tag_text(tagger=(b"Linus Torvalds <torvalds@woody.linux-foundation.org> " b"423423+0000")),
        )
