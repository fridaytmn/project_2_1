...
class GitClientTests(TestCase):
    ...
    def test_send_pack_no_sideband64k_with_update_ref_error(self) -> None:
        ...
        # side band data
        pkts = [
            b"55dcc6bf963f922e1ed5c4bbaaefcfacef57b1d7 capabilities^{}" b"\x00 report-status delete-refs ofs-delta\n",
            b"",
            b"unpack ok",
    ...
    def test_send_pack_new_ref_only(self):
        ...
        self.assertEqual(
            ...
            b"refs/heads/blah12\x00delete-refs ofs-delta report-status0000" + f.getvalue(),
        )
    ...
    def test_send_pack_no_deleteref_delete_only(self):
        pkts = [
            b"310ca9477129b8586fa2afc779c1f57cf64bba6c refs/heads/master" b"\x00 report-status ofs-delta\n",
            b"",
            b"",
        ]
        for pkt in pkts:
    ...
    def test_smart_request_content_type_with_directive_check(self):
        ...
        class PoolManagerMock:
            ...
            def request(
                ...
                return HTTPResponse(
                    headers={"Content-Type": "application/x-git-upload-pack-result; charset=utf-8"},
                    request_method=method,
                    request_url=url,
                    preload_content=preload_content,
                    status=200,
...
class RsyncUrlTests(TestCase):
    def test_simple(self):
        ...
        self.assertEqual(parse_rsync_url("user@foo:bar/path"), ("user", "foo", "bar/path"))
...
class GitCredentialStoreTests(TestCase):
    ...
    def test_match_with_matching_username(self):
        self.assertEqual(
            get_credentials_from_store(b"https", b"example.org", b"user", fnames=[self.fname]),
            (b"user", b"pass"),
        )

    def test_no_match_with_nonmatching_username(self):
        self.assertEqual(
            get_credentials_from_store(b"https", b"example.org", b"otheruser", fnames=[self.fname]),
            None,
        )
