...
class Repo(BaseRepo):
    ...
    def discover(cls, start="."):
        ...
        raise NotGitRepository("No git repository was found at {path}".format(**dict(path=start)))
    ...
    def stage(
        ...
        for fs_path in fs_paths:
            ...
            if os.path.isabs(fs_path):
                raise ValueError("path %r should be relative to " "repository root, not absolute" % fs_path)
        ...
        for fs_path in fs_paths:
            ...
            try:
                ...
                try:
                    ...
                    raise KeyError("file '%s' not in index" % (tree_path.decode())) from exc
        ...
        *,
        ...
        try:
            ...
            try:
                ...
                target.refs.import_refs(b"refs/tags", self.refs.as_dict(b"refs/tags"), message=ref_message)
                ...
                if origin_sha and not origin_head:
                    ...
                    head_ref = _set_default_branch(target.refs, origin, origin_head, branch, ref_message)
