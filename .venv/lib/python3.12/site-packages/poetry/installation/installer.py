...
class Installer:
    ...
    def _do_install(self) -> int:
        ...
        if not self._requires_synchronization:
            ...
            ops = [
                op for op in transaction.calculate_operations(with_uninstalls=True) if op.job_type == "uninstall"
            ] + ops
        else:
            ops = uninstalls + ops
    ...
    def _populate_lockfile_repo(self, repo: LockfileRepository, ops: Iterable[Operation]) -> list[Uninstall]:
        uninstalls = []
        for op in ops:
