    ...
    def handle(self) -> int:
        ...
        if version:
            ...
            if self.option("short"):
                ...
                self.line(
                    f"Bumping version from <b>{self.poetry.package.pretty_version}</>" f" to <fg=green>{version}</>"
                )
            ...
            if self.option("short"):
                ...
                self.line(
                    f"<comment>{self.poetry.package.pretty_name}</>" f" <info>{self.poetry.package.pretty_version}</>"
                )
