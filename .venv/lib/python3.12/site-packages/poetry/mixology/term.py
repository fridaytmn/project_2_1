...
class Term:
    ...
    def _intersect(self, other: Term) -> Term | None:
        ...
        if self._compatible_dependency(other.dependency):
            if self.is_positive() != other.is_positive():
                ...
                return self._non_empty_term(positive.constraint.difference(negative.constraint), True, other)
            elif self.is_positive():
                # foo ^1.0.0 ∩ foo >=1.5.0 <3.0.0 → foo ^1.5.0
                return self._non_empty_term(self.constraint.intersect(other.constraint), True, other)
            else:
                # not foo ^1.0.0 ∩ not foo >=1.5.0 <3.0.0 → not foo >=1.0.0 <3.0.0
                return self._non_empty_term(self.constraint.union(other.constraint), False, other)
    ...
    def _non_empty_term(self, constraint: VersionConstraint, is_positive: bool, other: Term) -> Term | None:
        ...
        dependency = (
            other.dependency
            if not self.dependency.is_direct_origin() and other.dependency.is_direct_origin()
