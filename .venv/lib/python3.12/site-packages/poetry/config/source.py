...
class Source:
    ...
    priority: Priority = Priority.PRIMARY  # cheating in annotation: str will be converted to Priority in __post_init__
    ...
    def to_dict(self) -> dict[str, str | bool]:
        return dataclasses.asdict(
            self,
            dict_factory=lambda x: {k: v if not isinstance(v, Priority) else v.name.lower() for (k, v) in x if v},
        )
