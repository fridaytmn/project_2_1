...
class Repository(AbstractRepository):
    ...
    def find_packages(self, dependency: Dependency) -> list[Package]:
        ...
        for package in self._find_packages(dependency.name, constraint):
            if package.yanked and not isinstance(constraint, Version):
                ...
                # version
                continue
            if package.is_prerelease() and not allow_prereleases and not package.is_direct_origin():
    ...
    def has_package(self, package: Package) -> bool:
        ...
        return any(package_id == repo_package.unique_name for repo_package in self.packages)
    ...
    def _find_packages(self, name: NormalizedName, constraint: VersionConstraint) -> list[Package]:
        return [package for package in self._packages if package.name == name and constraint.allows(package.version)]
