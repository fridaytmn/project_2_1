...
class BuildSystem:
    def __init__(self, build_backend: str | None = None, requires: list[str] | None = None) -> None:
        self.build_backend = build_backend if build_backend is not None else "setuptools.build_meta:__legacy__"
