...
RELEASE_PHASE_NORMALIZATIONS = {s: id_ for id_, spellings in RELEASE_PHASE_SPELLINGS.items() for s in spellings}
...
class Release:
    ...
    def __post_init__(self) -> None:
        ...
        parts = [str(part) for part in (self.major, self.minor, self.patch, *self.extra) if part is not None]
    ...
    def to_parts(self) -> Sequence[int]:
        return tuple(part for part in [self.major, self.minor, self.patch, *self.extra] if part is not None)
...
class ReleaseTag:
    ...
    def __post_init__(self) -> None:
        object.__setattr__(self, "phase", RELEASE_PHASE_NORMALIZATIONS.get(self.phase, self.phase))
