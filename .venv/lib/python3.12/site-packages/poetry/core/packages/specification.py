...
class PackageSpecification:
    ...
    def is_same_source_as(self, other: PackageSpecification) -> bool:
        ...
        if (self._source_url or other.source_url) and self._source_url != other.source_url:
            return False
    ...
    def with_features(self: T, features: Iterable[str]) -> T:
        ...
        package._features = frozenset(canonicalize_name(feature) for feature in features)
    ...
    def __hash__(self) -> int:
        ...
        if self._source_type:
            ...
            result ^= hash(self._source_type) ^ hash(self._source_url) ^ hash(self._source_subdirectory)
