...
class Version(PEP440Version, VersionRangeConstraint):
    ...
    def allows_all(self, other: VersionConstraint) -> bool:
        return other.is_empty() or (self.allows(other) if isinstance(other, self.__class__) else other == self)
    ...
    def __eq__(self, other: object) -> bool:
        ...
        if isinstance(other, VersionRange):
            return self == other.min and self == other.max and (other.include_min or other.include_max)
