...
class VersionRange(VersionRangeConstraint):
    ...
    def allows_any(self, other: VersionConstraint) -> bool:
        ...
        if isinstance(other, Version):
            ...
            return self.min is not None and self.min.is_local() and other.allows(self.min)
    ...
    def is_single_wildcard_range(self) -> bool:
        ...
        if self.min is None or self.max is None or not self.include_min or self.include_max:
            return False
    ...
    def __hash__(self) -> int:
        return hash(self.min) ^ hash(self.max) ^ hash(self.include_min) ^ hash(self.include_max)
