...
def build_wheel(
    ...
    return WheelBuilder.make_in(poetry, Path(wheel_directory), metadata_directory=metadata_path)
...
def build_editable(
    ...
    return WheelBuilder.make_in(poetry, Path(wheel_directory), metadata_directory=metadata_path, editable=True)
