            ...
            ### The Earley predictor
                ...
                if item.expect in held_completions:
                    ...
                    new_item.node.add_family(
                        new_item.s, new_item.rule, new_item.start, item.node, held_completions[item.expect]
                    )
                    new_items.append(new_item)
        ...
        def scan(i, token, to_scan):
            ...
            if not next_set and not next_to_scan:
                ...
                raise UnexpectedToken(
                    token, expect, considered_rules=set(to_scan), state=frozenset(i.s for i in to_scan)
                )
    ...
    def parse(self, lexer, start):
        ...
        if self.Tree is not None:
            ...
            transformer = ForestToParseTree(
                self.Tree, self.callbacks, self.forest_sum_visitor and self.forest_sum_visitor(), self.resolve_ambiguity
            )
