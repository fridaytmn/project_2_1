...
flags = [("d", "debug"), "keep_all_tokens", "regex", "propagate_positions", "maybe_placeholders", "use_bytes"]

options = ["start", "lexer"]

lalr_argparser.add_argument(
    "-v", "--verbose", action="count", default=0, help="Increase Logger output level, up to three times"
)
...
lalr_argparser.add_argument(
    "-o", "--out", type=FileType("w", encoding=encoding), default=sys.stdout, help="the output file (default=stdout)"
)
