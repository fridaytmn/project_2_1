            ...
            if directive in ("builtin", "include"):
                ...
                if path not in includes:
                    ...
                    rule_defs += _nearley_to_lark(
                        text, builtin_path, n2l, js_code, os.path.abspath(os.path.dirname(path)), includes
                    )
            else:
...
def main(fn, start, nearley_lib, es6=False):
    ...
    return create_code_for_nearley_grammar(
        grammar, start, os.path.join(nearley_lib, "builtin"), os.path.abspath(os.path.dirname(fn)), es6=es6
    )
