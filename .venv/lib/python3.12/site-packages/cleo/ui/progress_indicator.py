...
class ProgressIndicator:
    ...
    def __init__(
        ...
        if len(values) < 2:
            raise ValueError("The progress indicator must have at " "least 2 indicator value characters.")
    ...
    def _display(self) -> None:
        ...
        self._overwrite(re.sub(r"(?i){([a-z\-_]+)(?::([^}]+))?}", self._overwrite_callback, self._fmt))
