...
class TableStyle:
    ...
    def set_horizontal_border_chars(self, outside: str, inside: str | None = None) -> TableStyle:
        """
    ...
    def set_vertical_border_chars(self, outside: str, inside: str | None = None) -> TableStyle:
        """
    ...
    def set_crossing_chars(
        ...
        self._crossing_top_left_bottom_char = mid_left if top_left_bottom is None else top_left_bottom
        self._crossing_top_mid_bottom_char = cross if top_mid_bottom is None else top_mid_bottom
        self._crossing_top_right_bottom_char = mid_right if top_right_bottom is None else top_right_bottom
    ...
    def set_default_crossing_char(self, char: str) -> TableStyle:
        ...
        """
        return self.set_crossing_chars(char, char, char, char, char, char, char, char, char)
    ...
    def set_pad_type(self, pad_type: str) -> TableStyle:
        ...
        if pad_type not in {"left", "right", "center"}:
            raise ValueError('Invalid padding type. Expected one of "left", "right", "center").')
