...
class ApplicationDescription:
    ...
    def _sort_commands(self, commands: dict[str, Command]) -> list[tuple[str, list[tuple[str, Command]]]]:
        """
        ...
        namespaced_commands_list: dict[str, list[tuple[str, Command]]] = {
            namespace: sorted(commands.items()) for namespace, commands in namespaced_commands.items()
        }
