...
class SectionOutput(StreamOutput):
    def __init__(
        ...
        super().__init__(stream, verbosity=verbosity, decorated=decorated, formatter=formatter)
    ...
    def clear(self, lines: int | None = None) -> None:
        ...
        super()._write(self._pop_stream_content_until_current_section(lines), new_line=False)
    ...
    def add_content(self, content: str) -> None:
        for line_content in content.split("\n"):
            self._lines += (
                math.ceil(len(self.remove_format(line_content).replace("\t", " " * 8)) / self._terminal.width) or 1
            )
    ...
    def _pop_stream_content_until_current_section(self, lines_to_clear_count: int = 0) -> str:
        erased_content = []
